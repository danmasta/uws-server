import { METHODS_HTTP as METHODS, SYMBOLS } from './constants.js';
...
export class uWSRequest {
    ...
    get headers () {
        return this[SYMBOLS.state].headers;
    }
    ...
    get signal () {
        return this[SYMBOLS.state].ac.signal;
    }
    ...
    createRequest () {
        ...
        let body, { url, method, headers, ac, socket } = this[SYMBOLS.state];
