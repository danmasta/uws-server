...
export class uWSRequest {
    ...
    constructor (socket, httpReq, { defaultHost, scheme='http' }={}) {

        let method = METHODS[httpReq.getMethod()] || 'GET';
        let path = httpReq.getUrl() || '';
        let query = httpReq.getQuery() || '';
        let headers = getHeaders(httpReq);
